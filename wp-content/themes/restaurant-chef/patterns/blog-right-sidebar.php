 ...
 * Slug: restaurant-chef/blog-right-sidebar
 * Categories: restaurant-chef, blog-right-sidebar
 */
?>
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"restaurant-chef","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->